<main class="col">
    ...
    <script>
        function pret() {
            var elemen = document.getElementById("tombo");
            var checc = document.getElementById("pku");
            if (checc.checked == true) {
                elemen.hidden = true;
            }
        }
    </script>
    ...
    ?>
        <div class="row">
            <div class="col">
                <input onclick="pret()" type="checkbox" id="pku">
                <button id="tombo">ayam</button>
                <h4 class="mb-3">Form Transaksi</h4>
                <form action="" method="POST" class="needs-validation" novalidate style="font-size: larger;">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group">
                                <label for="namal" class="form-label col-form-label col-4">Kode Transaksi</label>
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-4 col-md-6">
                                <label for="alamat" class="form-label col-form-label col-4">Jenis Transaksi</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group mb-4">
                                <label for="pekerjaan" class="form-label col-form-label col-4">Tanggal Transaksi</label>
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-4">
                                <label for="pekerjaan" class="form-label col-form-label col-4">Nomor Referensi</label>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="input-group mb-4 d-none supplier_show">
                                <label for="Nama Supplier" class="form-label col-form-label col-4">Supplier</label>
                            ...
                            <div class="input-group col-md-6 mb-4 d-none cust_show">
                                <label for="Nama Supplier" class="form-label col-form-label col-4">Customer</label>
